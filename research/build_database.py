...
ARCHIVE = os.environ.get(
    'PYTECTOR_ARCHIVE',
    r'C:\Users\龐麒修\iCloudDrive\claude cowork\古應力分析\清水溪應力')
ADOPTED = r'F:\Obsidian\Obsidian\10_專題整理\古應力測站總表.csv'
LOCALITIES = (r'C:\Users\龐麒修\iCloudDrive\FieldMove資料\古應力資料點'
              r'\localities 3.csv')
OUTDIR = sys.argv[1] if len(sys.argv) > 1 else r'F:\古應力資料庫'
